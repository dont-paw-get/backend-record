...
#
# CLIAR-121: Scrap 저장 책임이 backend-book으로 이전되어 Scrap model을
# 이 저장소에서 제거했다. 다만 과거 migration(0bed2a9a23f9)으로 생성된
# scrap 테이블은 배포된 DB에 이미 남아 있을 수 있다. Legacy scrap
# table/migration may still exist in deployed DB. Do NOT accept an
# autogenerated DROP for scrap without a separate DB cleanup
# decision/Jira.
